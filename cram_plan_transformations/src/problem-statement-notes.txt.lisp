...
;; or maybe
`((action-verb flip-1 flip-1-8 flip.v.08) (theme pancake-3 pancake-3-1 pancake.n.01))
;; ^ better not, the intermediate variables are just autogenerated choice points
;; from which the most probably one is selected
