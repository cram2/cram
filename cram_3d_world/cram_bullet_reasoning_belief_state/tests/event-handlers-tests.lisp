...
(define-test kitchen-island-counter-edge-unstable-with-recovery-test
  (let* ((obj-name :bowl-1)
         (obj-type :bowl)
         (spawn-pose (cl-transforms-stamped:make-pose-stamped
                      "map" 0.0
...
(define-test sink-area-drawer-unstable-with-recovery-test
  (let* ((obj-name :bowl-1)
         (obj-type :bowl)
         (spawn-pose (cl-transforms-stamped:make-pose-stamped
                      "map" 0.0
                      (cl-transforms:make-3d-vector 1.599 0.8799 0.71)
                      (cl-transforms:make-identity-rotation)))
         (spawned-object))
    (let ((kitchen-urdf 
            (cl-urdf:parse-urdf 
