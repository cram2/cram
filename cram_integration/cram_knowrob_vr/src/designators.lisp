...
;; pick and place designators --------------------------------------------------
(cram-prolog:def-fact-group kvr-pick-and-place-plans (desig:action-grounding)
  (cram-prolog:<- (desig:action-grounding
    ...
    (cram-prolog:-> (spec:property ?action-designator
                                   (:arm (lisp-fun kvr::get-hand ?object-name))) ;;TODO
        (true)
...
(cram-prolog:def-fact-group pick-and-place-atomic-actions (desig:action-grounding)
  ...
  ;; TODO
;  (cram-prolog:<- (desig:action-grounding ?action-designator (navigate :to-pickup)
;    (spec:property ?action-designator (:type :going))
;    (spec:property ?action-designator (:target
;                                       (lisp-fun kvr::get-object-location-at-start-by-object-type
