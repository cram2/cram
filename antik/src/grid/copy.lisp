...
;; Time-stamp: <2013-12-25 19:34:52EST copy.lisp>
;;
...
(defun copy-to (object &optional (type *default-grid-type*) (element-type *default-element-type*))
  ...
  (copy object :grid-type type :element-type element-type))
