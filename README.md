...
* **cram_boxy** Hardware interface for using Boxy robot in CRAM.
...
* **cram_pr2** Hardware interface for using PR2 robot in CRAM and lightweight simulation of PR2 robot.
* **cram_roboserlock** 
