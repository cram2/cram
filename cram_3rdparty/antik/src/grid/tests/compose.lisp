...
;; Time-stamp: <2015-04-25 14:52:26EDT compose.lisp>
;;
  ...
  (lisp-unit:assert-numerical-equal
   ...
   (contents
    (concatenate-grids
     ...
     (make-grid-sequential-elements
      :offset 0.5d0 :destination-specification '((array 2 4) double-float)))))
  (lisp-unit:assert-numerical-equal
   ...
   (contents
    (concatenate-grids
     (make-grid-sequential-elements
      :offset 0.5d0 :destination-specification '((array 3 4) double-float))
     (make-grid-sequential-elements
      :offset 0.1d0 :destination-specification '((array 3 2) double-float))
     :axis 1)))
  #+(or)			   ; not yet ready for composite grids
  (lisp-unit:assert-numerical-equal
