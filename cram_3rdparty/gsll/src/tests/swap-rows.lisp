    ...
    (LET ((M1
	   (GRID:MAKE-FOREIGN-ARRAY
	    ...
	    '((-34.5f0 8.24f0 3.29f0)
	      ...
	      (49.27f0 -13.49f0 32.5f0)))))
      (GRID:COPY-TO (SWAP-ROWS M1 0 1) 'array 'single-float))))
  (LISP-UNIT::ASSERT-NUMERICAL-EQUAL
   (LIST
    ...
    (LET ((M1
	   (GRID:MAKE-FOREIGN-ARRAY
	    ...
	    '((-34.5d0 8.24d0 3.29d0)
	      ...
	      (49.27d0 -13.49d0 32.5d0)))))
      (GRID:COPY-TO (SWAP-ROWS M1 0 1) 'array 'double-float))))
  (LISP-UNIT::ASSERT-NUMERICAL-EQUAL
   (LIST
    #2A((#C(-8.93f0 34.12f0) #C(-6.15f0 49.27f0) #C(-13.49f0 32.5f0))
   ...
   (MULTIPLE-VALUE-LIST
    (LET ((M1
      ...
      (GRID:COPY-TO (SWAP-ROWS M1 0 1) 'array '(complex single-float)))))
  (LISP-UNIT::ASSERT-NUMERICAL-EQUAL
   (LIST
    ...
    (LET ((M1
	   (GRID:MAKE-FOREIGN-ARRAY
	    ...
	    '((#C(-34.5d0 8.24d0) #C(3.29d0 -8.93d0) #C(34.12d0 -6.15d0))
	      ...
	      (#C(49.27d0 -13.49d0) #C(32.5d0 42.73d0) #C(-17.24d0 43.31d0))))))
      (GRID:COPY-TO (SWAP-ROWS M1 0 1) 'array '(complex double-float)))))
  (LISP-UNIT::ASSERT-NUMERICAL-EQUAL
   ...
   (MULTIPLE-VALUE-LIST
    (LET ((M1
      ...
      (GRID:COPY-TO (SWAP-ROWS M1 0 1) 'array '(signed-byte 8)))))
  (LISP-UNIT::ASSERT-NUMERICAL-EQUAL
   ...
   (MULTIPLE-VALUE-LIST
    (LET ((M1
      ...
      (GRID:COPY-TO (SWAP-ROWS M1 0 1) 'array '(unsigned-byte 8)))))
  (LISP-UNIT::ASSERT-NUMERICAL-EQUAL
   (LIST #2A((-91 52 -10) (-64 -68 71) (73 -5 123)))
   (MULTIPLE-VALUE-LIST
    (LET ((M1
	   (GRID:MAKE-FOREIGN-ARRAY
	    ...
	    :INITIAL-CONTENTS
	    '((-64 -68 71) (-91 52 -10) (73 -5 123)))))
      (GRID:COPY-TO (SWAP-ROWS M1 0 1) 'array '(signed-byte 16)))))
  (LISP-UNIT::ASSERT-NUMERICAL-EQUAL
   (LIST #2A((116 163 140) (67 44 189) (161 215 98)))
   (MULTIPLE-VALUE-LIST
    (LET ((M1
	   (GRID:MAKE-FOREIGN-ARRAY
	    ...
	    :INITIAL-CONTENTS
	    '((67 44 189) (116 163 140) (161 215 98)))))
      (GRID:COPY-TO (SWAP-ROWS M1 0 1) 'array '(unsigned-byte 16)))))
  (LISP-UNIT::ASSERT-NUMERICAL-EQUAL
   (LIST #2A((-91 52 -10) (-64 -68 71) (73 -5 123)))
   (MULTIPLE-VALUE-LIST
    (LET ((M1
	   (GRID:MAKE-FOREIGN-ARRAY
	    ...
	    :INITIAL-CONTENTS
	    '((-64 -68 71) (-91 52 -10) (73 -5 123)))))
      (GRID:COPY-TO (SWAP-ROWS M1 0 1) 'array '(signed-byte 32)))))
  (LISP-UNIT::ASSERT-NUMERICAL-EQUAL
   (LIST #2A((116 163 140) (67 44 189) (161 215 98)))
   (MULTIPLE-VALUE-LIST
    (LET ((M1
	   (GRID:MAKE-FOREIGN-ARRAY
	    ...
	    :INITIAL-CONTENTS
	    '((67 44 189) (116 163 140) (161 215 98)))))
      (GRID:COPY-TO (SWAP-ROWS M1 0 1) 'array '(unsigned-byte 32)))))
  #+int64
  (LISP-UNIT::ASSERT-NUMERICAL-EQUAL
   (LIST #2A((-91 52 -10) (-64 -68 71) (73 -5 123)))
   (MULTIPLE-VALUE-LIST
    (LET ((M1
	   (GRID:MAKE-FOREIGN-ARRAY
	    ...
	    :INITIAL-CONTENTS
	    '((-64 -68 71) (-91 52 -10) (73 -5 123)))))
      (GRID:COPY-TO (SWAP-ROWS M1 0 1) 'array '(signed-byte 64)))))
  #+int64
  (LISP-UNIT::ASSERT-NUMERICAL-EQUAL
   (LIST #2A((116 163 140) (67 44 189) (161 215 98)))
   (MULTIPLE-VALUE-LIST
    (LET ((M1
	   (GRID:MAKE-FOREIGN-ARRAY
	    ...
	    :INITIAL-CONTENTS
	    '((67 44 189) (116 163 140) (161 215 98)))))
      (GRID:COPY-TO (SWAP-ROWS M1 0 1) 'array '(unsigned-byte 64))))))
